<template>
    <div id="component">
      <h3 v-if="this.getReservations.length === 0">Det finnes ingen reservasjoner</h3>
      <div
        v-for="item in this.getReservations"
        :key="item.label"
      ...
      md-content="Reservasjonen din er nå avlyst!"
...
export default {
  ...
  mounted () {
    /* console.log(this.getReservations) */
  },
  computed: {
    ...mapGetters([
      'deletedReservationStatus',
      'getReservations'
    ])
  },
  methods: {
